...
namespace SimpleFogOfWar.Renderers
{
	...
	public class SeeThroughFogRenderer : FOWRenderer
	{
		...
		public override void SetColor (Color value)
		{
			if (displayMat == null)
				return;
			if (displayMat.HasProperty (shaderColorID))
				displayMat.SetColor (shaderColorID, value);
		}
		...
		public override void SetBlur (float value)
		{
			if (displayMat == null)
				return;
			if (displayMat.HasProperty (shaderBlurID))
				displayMat.SetFloat (shaderBlurID, value);
		}
