	...
	protected override bool ShouldDrawProperties ()
	{
		...
		EditorGUI.BeginDisabledGroup(!isValid);
		{
			...
			if(NGUISettings.overflowStyle == UILabel.Overflow.ClampContent) {
				SerializedProperty ads = NGUIEditorTools.DrawPaddedProperty("AppendEndingString", serializedObject, "isAppendEndingString");	
				if(ads.boolValue) {
					NGUIEditorTools.DrawPaddedProperty("AppendString", serializedObject, "AppendString");	
				}
			}
			#endregion
