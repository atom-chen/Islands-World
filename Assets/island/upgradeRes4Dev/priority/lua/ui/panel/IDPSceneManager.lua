...
do
    ...
    function IDPSceneManager.loadCity()
        ...
        if dragSetting then
            ...
            dragSetting.dragMovement = Vector3.one-- * 0.4
        ...
        IDMainCity.init(IDPSceneManager.onLoadCity, IDPSceneManager.onProgress)
    end
    ...
    function IDPSceneManager.loadWorldMap()
        ...
        if dragSetting then
            ...
            dragSetting.dragMovement = Vector3.one-- * 0.5
            dragSetting.scaleSpeed = 1
        end
        ...
        lookAtTarget.localEulerAngles = Vector3(0, 45, 0)
        IDWorldMap.init(bio2number(IDDBCity.curCity.pos),
                function()
                    SoundEx.playMainMusic("MainScene_1")
                    getPanelAsy("PanelMain", onLoadedPanel)
                end, IDPSceneManager.onProgress)
    end
    --------------------------------------------
