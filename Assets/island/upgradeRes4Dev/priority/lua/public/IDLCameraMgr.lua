...
do
    ...
    function IDLCameraMgr.init()
        ...
        IDLCameraMgr.getProfile("normal", function()
    ...
    function IDLCameraMgr.isInCameraView(camera, bounds)
        camera = camera or self.maincamera
        return csSelf.isInCameraView(camera, bounds)
    end
